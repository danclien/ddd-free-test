...
import schoolobjects.workshop.c_course_editing_coyoneda_eithert._, CourseEditingM._

class CourseEditingCoyonedaEitherTSpec extends FunSpec with Matchers with IntegrationSpec {

  describe("CourseEditingMCoyonedaEitherT") {
